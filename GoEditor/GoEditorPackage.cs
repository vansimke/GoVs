...
using allibeccom.GoEditor.LanguageService;
...
namespace allibeccom.GoEditor
{
    ...
    [Guid(GuidList.guidGoEditorPkgString)]
    [ProvideService(typeof(GoLanguageService))]
    [ProvideLanguageService(typeof(GoLanguageService),
        "Go Language Service",
        106,
        CodeSense = false,
    ...
    public sealed class GoEditorPackage : Package
    {
        /// <summary>
